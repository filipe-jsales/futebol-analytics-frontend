  ...
  return (
    <>
      <nav className="navbar text-dark bg-light">
        <h2 className="font-weight-bold text-center">Team</h2>
      </nav>
              ...
              <div className="row">
                ...
                <div className="col-md-9">
                  ...
                  <ul className="general-info">
                    <li>
                      <h3>
                        <strong className="text-white">Founded:</strong>
                        <span className="text-light"> {teams.founded}</span>
                      </h3>
                    </li>
                    <li>
                      <h3>
                        <strong className="text-primary">ShortName:</strong>
                        <span className="text-light"> {teams.tla}</span>
                      </h3>
                    </li>
                    <li>
                      <h3>
                        <strong className="text-primary">Jersey Color:</strong>
                        <span className="text-light"> {teams.clubColors}</span>
                      </h3>
                    </li>
                    <li>
                      <h3>
                        <strong className="text-primary">Stadium:</strong>{" "}
                        <span className="text-light">{teams.venue}</span>
                      </h3>
                    </li>
                    <li>
                      <h3>
            ...
            <div className="row">
              <div className="col-xl-12 col-md-12 sticky-top">
                <ul className="nav nav-tabs" id="myTab">
                  <li>
                    <a href="#squad" data-bs-toggle="tab">
                      SQUAD
                    </a>
                  </li>
                  <li>
                    <a href="#fixtures" data-bs-toggle="tab">
                      FIXTURES
                    </a>
                  </li>
                </ul>
                  ...
                  <div className="tab-pane active" id="squad">
                    ...
                    <div className="col-lg-6 col-xl-6 mt-2" id="fixtures">
                      <div className="recent-results">
                        <h5>
                          <a href="group-list.html">Recent Result</a>
                        </h5>
                              ...
                              return (
                                <li key={index + 1}>
                                  ...
                                  <div className="goals-result">
                                    <img
                                      src={item.homeTeam && item.homeTeam.crest}
                                      alt={item.homeTeam && item.homeTeam.name}
                                    />
                                    ...
                                    <img
                                      src={item.awayTeam && item.awayTeam.crest}
                                      alt={item.awayTeam && item.awayTeam.name}
                                    />
