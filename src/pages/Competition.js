  ...
  return (
    <>
      <nav className="navbar text-dark bg-light">
        <h2 className="font-weight-bold text-center">Competition</h2>
      </nav>
              ...
              <div className="row">
                <div className="col-lg-8">
                  <div className="recent-results">
                    <h5>
                      <a href="group-list.html">Table Standings</a>
                    </h5>
                ...
                <div className="col-lg-6 col-xl-4">
                  <div className="player-ranking">
                    <h5>
                      <a href="group-list.html">Top Scorer</a>
                    </h5>
                        ...
                        {scorers?.map((item, index) => {
                          return (
                            <li key={index + 1}>
                              ...
                              <span className="points">{item.goals}</span>
                            </li>
                          );
                        })}
                      </ul>
                          ...
                          return (
                            <li key={index + 1}>
                              <span className="head">
                                <img
                                  src={
                                    item.competition && item.competition.emblem
                                  }
                                  alt={
